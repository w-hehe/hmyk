...
) ENGINE = InnoDB AUTO_INCREMENT = 17 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '管理员日志表' ROW_FORMAT = COMPACT;

-- ----------------------------
-- Records of hm_admin_log
-- ----------------------------
INSERT INTO `hm_admin_log` VALUES (1, 1, 'admin', '/admin/plugin/market/install', '', '{\"plugin_id\":\"9\",\"uid\":\"1\",\"token\":\"***\",\"upgrade\":\"0\"}', '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/112.0.0.0 Safari/537.36', 1681574528);
INSERT INTO `hm_admin_log` VALUES (2, 1, 'admin', '/admin/plugin/market/isbuy', '', '{\"plugin_id\":\"9\",\"uid\":\"1\",\"toekn\":\"e4717c1c-ad9c-4bbd-a541-0cf6cac6edb2\",\"out_trade_no\":\"20230416000208834192974\"}', '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/112.0.0.0 Safari/537.36', 1681574653);
INSERT INTO `hm_admin_log` VALUES (3, 1, 'admin', '/admin/plugin/market/install', '', '{\"plugin_id\":\"9\",\"uid\":\"1\",\"token\":\"***\",\"upgrade\":\"0\"}', '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/112.0.0.0 Safari/537.36', 1681574875);
INSERT INTO `hm_admin_log` VALUES (4, 1, 'admin', '/admin/plugin/myplugin/status/cmd/disable', '', '{\"action\":\"\",\"ids\":\"alipay\",\"params\":\"\",\"cmd\":\"disable\"}', '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/112.0.0.0 Safari/537.36', 1681574890);
INSERT INTO `hm_admin_log` VALUES (5, 1, 'admin', '/admin/plugin/myplugin/status/cmd/enable', '', '{\"action\":\"\",\"ids\":\"alipay\",\"params\":\"\",\"cmd\":\"enable\"}', '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/112.0.0.0 Safari/537.36', 1681574891);
INSERT INTO `hm_admin_log` VALUES (6, 1, 'admin', '/admin/plugin/myplugin/status/cmd/disable', '', '{\"action\":\"\",\"ids\":\"epay\",\"params\":\"\",\"cmd\":\"disable\"}', '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/112.0.0.0 Safari/537.36', 1681574892);
INSERT INTO `hm_admin_log` VALUES (7, 1, 'admin', '/admin/plugin/myplugin/status/cmd/disable', '', '{\"action\":\"\",\"ids\":\"shuiping\",\"params\":\"\",\"cmd\":\"disable\"}', '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/112.0.0.0 Safari/537.36', 1681574899);
INSERT INTO `hm_admin_log` VALUES (8, 1, 'admin', '/admin/plugin/myplugin/status/cmd/disable', '', '{\"action\":\"\",\"ids\":\"scan\",\"params\":\"\",\"cmd\":\"disable\"}', '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/112.0.0.0 Safari/537.36', 1681574901);
INSERT INTO `hm_admin_log` VALUES (9, 1, 'admin', '/admin/goods/stock/add/ids/10?dialog=1', '商品管理', '{\"dialog\":\"1\",\"sku\":[\"39\"],\"stock\":\"1\",\"ids\":\"10\"}', '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/112.0.0.0 Safari/537.36', 1681575440);
INSERT INTO `hm_admin_log` VALUES (10, 1, 'admin', '/admin/goods/stock/add/ids/10?dialog=1', '商品管理', '{\"dialog\":\"1\",\"sku\":[\"40\"],\"stock\":\"2\\r\\n2\",\"ids\":\"10\"}', '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/112.0.0.0 Safari/537.36', 1681575445);
INSERT INTO `hm_admin_log` VALUES (11, 1, 'admin', '/admin/goods/stock/add/ids/10?dialog=1', '商品管理', '{\"dialog\":\"1\",\"sku\":[\"42\"],\"stock\":\"3\\r\\n3\\r\\n3\",\"ids\":\"10\"}', '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/112.0.0.0 Safari/537.36', 1681575449);
INSERT INTO `hm_admin_log` VALUES (12, 1, 'admin', '/admin/plugin/myplugin/setting/plugin_name/shuiping/ids/9?dialog=1', '', '{\"dialog\":\"1\",\"eq\":[\"mobile\",\"pc\"],\"sku_price\":\"1\",\"sales\":\"1\",\"stock\":\"1\",\"blog\":\"0\",\"gg_status\":\"1\",\"gonggao\":\"源码内容仅供创业者下载学习之用。使用本程序开设的博客商城，网友可自由发布相关信息，但网友观点不代表我司的意见和倾向。除注明之服务条款外，对用户使用本程序时发生的包括但不限于下列有关事项依法不负任何责任：通过本程序进行的任何属于用户的活动及其结果；通过本程序发布的产品和资讯内容；非本网站可控制之原因而出现的任何意外、疏忽、资料的丢失或毁坏等；用户系统感染电脑病毒；因登入信息不准确、不合法或不真实导致的一切不良后果；因用户任何非法行为导致的所有不良后果；&amp;quot;黑客&amp;quot;以及其他不可抗力因素及其后果；其他依法应予免责的情况。\",\"plugin_name\":\"shuiping\",\"ids\":\"9\"}', '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/112.0.0.0 Safari/537.36', 1681575468);
INSERT INTO `hm_admin_log` VALUES (13, 1, 'admin', '/admin/plugin/myplugin/status/cmd/enable', '', '{\"action\":\"\",\"ids\":\"shuiping\",\"params\":\"\",\"cmd\":\"enable\"}', '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/112.0.0.0 Safari/537.36', 1681577383);
INSERT INTO `hm_admin_log` VALUES (14, 1, 'admin', '/admin/plugin/myplugin/delp/plugin_name/shuiping/ids/9', '', '{\"plugin_name\":\"shuiping\",\"ids\":\"9\"}', '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/112.0.0.0 Safari/537.36', 1681577387);
INSERT INTO `hm_admin_log` VALUES (15, 1, 'admin', '/admin/plugin/myplugin/setting/plugin_name/epay/ids/1?dialog=1', '', '{\"dialog\":\"1\",\"gateway_url\":\"\",\"appid\":\"\",\"secret_key\":\"\",\"plugin_name\":\"epay\",\"ids\":\"1\"}', '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/112.0.0.0 Safari/537.36', 1681577395);
INSERT INTO `hm_admin_log` VALUES (16, 1, 'admin', '/admin/plugin/myplugin/status/cmd/enable', '', '{\"action\":\"\",\"ids\":\"epay\",\"params\":\"\",\"cmd\":\"enable\"}', '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/112.0.0.0 Safari/537.36', 1681577397);
...
-- Records of hm_goods
-- ----------------------------
INSERT INTO `hm_goods` VALUES (1, 1, 'alone', '[{\"title\":\"\\u8d26\\u53f7\",\"placeholder\":\"\\u8bf7\\u8f93\\u5165\\u8d26\\u53f7\"},{\"title\":\"\\u5bc6\\u7801\",\"placeholder\":\"\\u8bf7\\u8f93\\u5165\\u5bc6\\u7801\"},{\"title\":\"\\u8054\\u7cfb\\u65b9\\u5f0f\",\"placeholder\":\"\\u8bf7\\u8f93\\u5165\\u8054\\u7cfb\\u65b9\\u5f0f\"}]', '[]', NULL, '惟有长江水，无语东流。 不忍登高临远，望故乡渺邈，归思难收。', 0, NULL, '/uploads/20230415/2d1a509c088b49ab0a11199652ea7aad.jpg', NULL, 0, NULL, NULL, 1, 0, 0, NULL, 1, NULL, NULL, NULL, NULL, NULL);
...
INSERT INTO `hm_goods` VALUES (6, 1, 'alone', '[]', '[]', NULL, '未遂风云便，争不恣狂荡。何须论得丧？才子词人，自是白衣卿相。', 0, NULL, '/uploads/20230415/12805cd6cfb0bb85deeb07e2c8a045ca.jpg', NULL, 1, NULL, NULL, 1, 0, 0, NULL, 6, NULL, NULL, NULL, NULL, NULL);
...
INSERT INTO `hm_options` VALUES (4, 'version', '1.0.8', '数据表版本');
...
INSERT INTO `hm_sku` VALUES (39, 10, '1111', '{\"crossed_price\":\"\",\"cost_price\":\"\",\"sale_price\":\"2.00\",\"agency_price_1\":\"\",\"agency_price_2\":\"\",\"agency_price_3\":\"\",\"agency_price_4\":\"\"}', 1);
INSERT INTO `hm_sku` VALUES (40, 10, '22233', '{\"crossed_price\":\"\",\"cost_price\":\"\",\"sale_price\":\"\",\"agency_price_1\":\"\",\"agency_price_2\":\"\",\"agency_price_3\":\"\",\"agency_price_4\":\"\"}', 2);
INSERT INTO `hm_sku` VALUES (42, 10, '123', '{\"crossed_price\":\"\",\"cost_price\":\"\",\"sale_price\":\"\",\"agency_price_1\":\"\",\"agency_price_2\":\"\",\"agency_price_3\":\"\",\"agency_price_4\":\"\"}', 3);
...
CREATE TABLE `hm_stock`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 7 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '库存数据' ROW_FORMAT = COMPACT;

-- ----------------------------
-- Records of hm_stock
-- ----------------------------
INSERT INTO `hm_stock` VALUES (1, 10, 39, '1', 1, 1681575440, NULL);
INSERT INTO `hm_stock` VALUES (2, 10, 40, '2', 1, 1681575445, NULL);
INSERT INTO `hm_stock` VALUES (3, 10, 40, '2', 1, 1681575445, NULL);
INSERT INTO `hm_stock` VALUES (4, 10, 42, '3', 1, 1681575449, NULL);
INSERT INTO `hm_stock` VALUES (5, 10, 42, '3', 1, 1681575449, NULL);
INSERT INTO `hm_stock` VALUES (6, 10, 42, '3', 1, 1681575449, NULL);
